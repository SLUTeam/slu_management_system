...
public class StudentDashboard extends JFrame {
    ...
    public StudentDashboard(String username, String email, String role) {
        ...
        setTitle("Student Dashboard - SLU Management System");
        setSize(1100, 700);
        ...
        JButton coursesBtn = new JButton("Register Courses");
        JButton logoutBtn = new JButton("Logout");

        Dimension buttonSize = new Dimension(150, 35);
        Font buttonFont = new Font("Arial", Font.PLAIN, 14);
        JButton[] buttons = {homeBtn, profileBtn, coursesBtn, logoutBtn};
