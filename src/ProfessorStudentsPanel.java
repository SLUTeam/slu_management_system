...
public class ProfessorStudentsPanel {
    ...
    public static JPanel createProfessorStudentsPanel(int professorId) {
        ...
        // Hide the email column from view
                ...
                try (ResultSet rs = ps.executeQuery()) {
                    while (rs.next()) {
                        model.addRow(new Object[] {
                            ...
                            rs.getString("student_email") // hidden
                        });
                    }
                }
        ...
        // Enable Message button on selection
        ...
        // Message action: prompt and send email
        messageBtn.addActionListener(e -> {
            ...
            int result = JOptionPane.showConfirmDialog(
                panel, msgPanel, "Compose Message",
